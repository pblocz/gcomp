...
de manera que para $k=1$ se tiene:

\begin{equation}
\left[\tau_{i},\tau_{i+1}\right]f=\left(\left[\tau_{i}\right]g\right)\text{·}\left(\left[\tau_{i},\tau_{i+1}\right]h\right)+\left(\left[\tau_{i},\tau_{i+1}\right]g\right)\text{·}\left(\left[\tau_{i+1}\right]h\right)
\end{equation}
...
\[
\left[\tau_{1}\right]g=g(\tau_{i})=\tau_{i}\:\rightarrow\:\left[\tau_{1},\tau_{2}\right]g=\frac{g(\tau_{1})-g(\tau_{2})}{\tau_{1}-\tau_{2}}=\frac{\tau_{1}-\tau_{2}}{\tau_{1}-\tau_{2}}=1\:\rightarrow\:
\]
